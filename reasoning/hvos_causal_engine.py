...
from hvos_config import HVOS_ROOT, KG_DB, EVENTS_DB
...
class DirectedAcyclicGraph:
    ...
    Enforces: adding an edge that creates a cycle returns False.
    topological_sort() raises ValueError if a cycle is somehow present.
    """
...
EVENT_TYPE_MAP = {
    ...
    "ACTUAL_RECORDED": CausalNodeType.OUTCOME,
    "PREDICTION_ERROR_COMPUTED": CausalNodeType.OUTCOME,
