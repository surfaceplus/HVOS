...
class AgentFactory:
    ...
    def __init__(self, db_path: str = None):
        if db_path is None:
            db_path = r"C:\Users\Administrator\AppData\Local\hermes\hvos\knowledge-graph\agent_factory.db"
...
if __name__ == "__main__":
    ...
    db = args.db or r"C:\Users\Administrator\AppData\Local\hermes\hvos\knowledge-graph\agent_factory.db"
