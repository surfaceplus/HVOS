...
class KnowledgeReasoner:
    ...
    def infer_causal_chain(self, opp_id, event_store_db=None):
        if event_store_db is None:
            event_store_db = r"C:\Users\Administrator\AppData\Local\hermes\hvos\reality\events.db"
...
if __name__ == "__main__":
    ...
    db = r"C:\Users\Administrator\AppData\Local\hermes\hvos\knowledge-graph\kg.db"
