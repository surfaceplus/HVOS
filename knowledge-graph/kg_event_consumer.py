...
class KGEventConsumer:
    ...
    def rebuild_kg_from_scratch(self, event_store_path: str = None) -> dict:
        ...
        if event_store_path is None:
            event_store_path = r"C:\Users\Administrator\AppData\Local\hermes\hvos\hvos_v7\event_store.db"
...
if __name__ == "__main__":
    ...
    if args.action == "rebuild":
        es = args.event_store or r"C:\Users\Administrator\AppData\Local\hermes\hvos\reality\events.db"
